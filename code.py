...
from pynput.keyboard import Controller #to capture keyboard input
    ...
    if lmList:
        for button in StoredVar:
            ...
            if x < lmList[8][0] < x + w and y < lmList[8][1] < y + h:
                ...
                x2,y2=lmList[12][0],lmList[12][1] #8 , 12 that will be use to click
                l=math.hypot(x2-x1-30,y2-y1-30)
                print(l)
                ## when clicked
                if not l > 63:  #value when clicked
